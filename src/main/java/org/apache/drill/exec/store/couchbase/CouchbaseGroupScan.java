...
import org.apache.drill.exec.store.couchbase.CouchbaseSubScan.HBaseSubScanSpec;
...
public class CouchbaseGroupScan extends AbstractGroupScan implements DrillCouchbaseConstants {
  ...
  private CouchbaseScanSpec hbaseScanSpec;
  ...
  @JsonCreator
  public CouchbaseGroupScan(@JsonProperty("hbaseScanSpec") CouchbaseScanSpec hbaseScanSpec,
                        @JsonProperty("storage") CouchbaseStoragePluginConfig storagePluginConfig,
                        @JsonProperty("columns") List<SchemaPath> columns,
                        @JacksonInject StoragePluginRegistry pluginRegistry) throws IOException, ExecutionSetupException {
    this ((CouchbaseStoragePlugin) pluginRegistry.getPlugin(storagePluginConfig), hbaseScanSpec, columns);
  }

  public CouchbaseGroupScan(CouchbaseStoragePlugin storagePlugin, CouchbaseScanSpec scanSpec, List<SchemaPath> columns) {
  ...
  private void verifyColumns() {
    ...
    for (SchemaPath column : columns) {
      if (!(column.equals(ROW_KEY_PATH) || hTableDesc.hasFamily(CouchbaseUtils.getBytes(column.getRootSegment().getPath())))) {
  ...
  private HBaseSubScanSpec regionInfoToSubScanSpec(HRegionInfo ri) {
    CouchbaseScanSpec spec = hbaseScanSpec;
  ...
  public CouchbaseSubScan getSpecificScan(int minorFragmentId) {
    assert minorFragmentId < endpointFragmentMapping.size() : String.format(
        ...
        minorFragmentId);
    return new CouchbaseSubScan(storagePlugin, storagePluginConfig, endpointFragmentMapping.get(minorFragmentId), columns);
  }
  ...
  @JsonProperty
  public CouchbaseScanSpec getHBaseScanSpec() {
   ...
   */
  @VisibleForTesting
  public CouchbaseGroupScan() { }

  /**
   * Do not use, only for testing.
   */
  @VisibleForTesting
  public void setHBaseScanSpec(CouchbaseScanSpec hbaseScanSpec) {
